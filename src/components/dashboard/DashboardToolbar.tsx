...
export function DashboardToolbar({
    ...
    return (
        <div className="mb-10 space-y-4">
            <div className="flex flex-col gap-4 bg-white/60 dark:bg-slate-900/40 p-3 md:p-2 rounded-3xl md:rounded-[3rem] border border-slate-200/60 dark:border-slate-800/60 backdrop-blur-xl shadow-2xl shadow-blue-500/5 transition-all duration-500">
                ...
                <div className="flex items-center gap-3 overflow-x-auto pb-2 md:pb-0 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700 scrollbar-track-transparent">
                    {/* Status Filter */}
                    <Select value={statusFilter} onValueChange={setStatusFilter}>
                        <SelectTrigger className="shrink-0 w-[150px] h-12 bg-white dark:bg-slate-950 border-none rounded-2xl md:rounded-[2rem] shadow-inner font-bold text-slate-600 dark:text-slate-300">
                    ...
                    {/* View Toggle */}
                    <div className="shrink-0 flex items-center gap-1 bg-white dark:bg-slate-950 p-1 rounded-2xl md:rounded-[2rem] shadow-inner h-12">
                        <Button
                            variant="ghost"
                            size="icon"
                    ...
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <div className="shrink-0 flex items-center gap-3 bg-white dark:bg-slate-950 px-4 h-12 rounded-2xl md:rounded-[2rem] shadow-inner cursor-help">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    disabled={isSyncing}
                                    className={`shrink-0 h-12 px-6 md:px-8 rounded-2xl md:rounded-[2rem] font-black text-xs md:text-sm uppercase tracking-wider gap-2 shadow-xl transition-all active:scale-95 ${isSyncing
