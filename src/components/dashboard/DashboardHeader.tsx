            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="overflow-hidden border-none shadow-xl bg-white dark:bg-slate-900/40 backdrop-blur-md relative group transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 ring-1 ring-slate-200 dark:ring-slate-800 rounded-3xl cursor-help">
                    ...
                    <TooltipContent className="rounded-xl font-bold text-xs bg-slate-900 text-white border-none px-3 py-1.5 shadow-xl">
                        Total applications detected in your ecosystem
                    </TooltipContent>
                </Tooltip>

                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="overflow-hidden border-none shadow-xl bg-white dark:bg-slate-900/40 backdrop-blur-md relative group transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 ring-1 ring-blue-500/10 dark:ring-blue-500/20 rounded-3xl cursor-help">
                    ...
                    <TooltipContent className="rounded-xl font-bold text-xs bg-blue-600 text-white border-none px-3 py-1.5 shadow-xl">
                        Active applications (Applied, Screen, Interview)
                    </TooltipContent>
                </Tooltip>

                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="overflow-hidden border-none shadow-xl bg-white dark:bg-slate-900/40 backdrop-blur-md relative group transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 ring-1 ring-purple-500/10 dark:ring-purple-500/20 rounded-3xl cursor-help">
                    ...
                    <TooltipContent className="rounded-xl font-bold text-xs bg-purple-600 text-white border-none px-3 py-1.5 shadow-xl">
                        Interviews and screenings scheduled
                    </TooltipContent>
                </Tooltip>

                <Tooltip>
                    <TooltipTrigger asChild>
                        <Card className="overflow-hidden border-none shadow-xl bg-white dark:bg-slate-900/40 backdrop-blur-md relative group transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 ring-1 ring-green-500/10 dark:ring-green-500/20 rounded-3xl cursor-help">
                    ...
                    <TooltipContent className="rounded-xl font-bold text-xs bg-green-600 text-white border-none px-3 py-1.5 shadow-xl">
                        Job offers received and active
                    </TooltipContent>
                </Tooltip>
            </div>
        </TooltipProvider>
